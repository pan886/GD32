...
#define SD_CS(n)  n?gpio_bit_write(GPIOB,GPIO_PIN_12,SET):gpio_bit_write(GPIOB,GPIO_PIN_12,RESET)
u8  SD_Type=0;//SD卡的类型
////////////////////////////////////移植修改区///////////////////////////////////
//移植时候的接口
//data:要写入的数据
//返回值:读到的数据
u16 SD_SPI_ReadWriteByte(u16 data)
{
//	u8 i = 0;
...
void SD_SPI_SpeedLow(void)
{
 	...
 	SPI1_SetSpeed(SPI_PSC_256);//设置到低速模式
}
//SD卡正常工作的时候,可以高速了
void SD_SPI_SpeedHigh(void)
{

 	SPI1_SetSpeed(SPI_PSC_2);//设置到高速模式
}
//SPI硬件层初始化
