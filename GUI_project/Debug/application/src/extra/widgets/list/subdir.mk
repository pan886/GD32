...
C_SRCS += \
../application/src/extra/widgets/list/lv_list.c 

OBJS += \
./application/src/extra/widgets/list/lv_list.o 

C_DEPS += \
./application/src/extra/widgets/list/lv_list.d 


# Each subdirectory must supply rules for building sources it contributes
application/src/extra/widgets/list/%.o: ../application/src/extra/widgets/list/%.c
	@echo 'Building file: $<'
