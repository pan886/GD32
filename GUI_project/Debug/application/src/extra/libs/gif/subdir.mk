...
C_SRCS += \
../application/src/extra/libs/gif/gifdec.c \
../application/src/extra/libs/gif/lv_gif.c 

OBJS += \
./application/src/extra/libs/gif/gifdec.o \
./application/src/extra/libs/gif/lv_gif.o 

C_DEPS += \
./application/src/extra/libs/gif/gifdec.d \
./application/src/extra/libs/gif/lv_gif.d 


# Each subdirectory must supply rules for building sources it contributes
application/src/extra/libs/gif/%.o: ../application/src/extra/libs/gif/%.c
	@echo 'Building file: $<'
