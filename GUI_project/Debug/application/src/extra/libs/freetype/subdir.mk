...
C_SRCS += \
../application/src/extra/libs/freetype/lv_freetype.c 

OBJS += \
./application/src/extra/libs/freetype/lv_freetype.o 

C_DEPS += \
./application/src/extra/libs/freetype/lv_freetype.d 


# Each subdirectory must supply rules for building sources it contributes
application/src/extra/libs/freetype/%.o: ../application/src/extra/libs/freetype/%.c
	@echo 'Building file: $<'
