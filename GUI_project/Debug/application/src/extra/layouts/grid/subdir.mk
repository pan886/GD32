...
C_SRCS += \
../application/src/extra/layouts/grid/lv_grid.c 

OBJS += \
./application/src/extra/layouts/grid/lv_grid.o 

C_DEPS += \
./application/src/extra/layouts/grid/lv_grid.d 


# Each subdirectory must supply rules for building sources it contributes
application/src/extra/layouts/grid/%.o: ../application/src/extra/layouts/grid/%.c
	@echo 'Building file: $<'
