...
C_SRCS += \
../application/src/extra/layouts/flex/lv_flex.c 

OBJS += \
./application/src/extra/layouts/flex/lv_flex.o 

C_DEPS += \
./application/src/extra/layouts/flex/lv_flex.d 


# Each subdirectory must supply rules for building sources it contributes
application/src/extra/layouts/flex/%.o: ../application/src/extra/layouts/flex/%.c
	@echo 'Building file: $<'
