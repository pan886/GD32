...
C_SRCS += \
../application/src/extra/others/snapshot/lv_snapshot.c 

OBJS += \
./application/src/extra/others/snapshot/lv_snapshot.o 

C_DEPS += \
./application/src/extra/others/snapshot/lv_snapshot.d 


# Each subdirectory must supply rules for building sources it contributes
application/src/extra/others/snapshot/%.o: ../application/src/extra/others/snapshot/%.c
	@echo 'Building file: $<'
