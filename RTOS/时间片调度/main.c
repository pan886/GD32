...
void start_task1(void *pvParameters)
{
    ...
    vListInitialise(&ListItem1);
    vListInitialise(&ListItem2);
    vListInitialise(&ListItem3);
   ...
   // countSemaphore = xSemaphoreCreateCounting(255,0);
    ...
    printf("TestList->xLsitEnd-pxnext			%#x	\r\n",TestList.xListEnd.pxNext);
    printf("ListItem1->pxnext					%#x	\r\n",ListItem1.pxNext);
    printf("testlist-xlistend->pxprevious		%#x	\r\n",TestList.xListEnd.pxPrevious);
    printf("ListItem1->pxprevious				%#x \r\n",ListItem1.pxPrevious);

    vListInsert(&TestList,&ListItem2);
    printf("/************insert listitem2*********/r\n");
    printf("TestList->xlistend->pxnext			%#x	\r\n",TestList.xListEnd.pxNext);
    printf("ListItem1->pxNext				%#x \r\n",ListItem1.pxNext);
    printf("ListItem2->pxNext				%#x \r\n",ListItem2.pxNext);
    printf("TestList->xlistend->previous			%#x	\r\n",TestList.xListEnd.pxPrevious);
    printf("ListItem1->pxprevious				%#x \r\n",ListItem1.pxPrevious);
